...
clsOpt1 = ClassificationReport(y_train=y_train, x_train=X_train, x_test=X_test, y_test=y_test,
                               model=rf)
clsOpt1.get_report(file_path="Reports/ClassificationReport--Multi-class--report_option-1", include_shap=True)
...
clsOpt2.get_report(file_path="Reports/ClassificationReport--Multi-class--report_option-2")